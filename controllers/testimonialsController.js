...
export const createTestimonialController = async (req, res) => {
    ...
    const testimonial = await testimonialsService.createTestimonial({ testimonial: text, owner: userId, recipeId });
...
export const getTestimonialsByRecipeIdController = async (req, res) => {
    ...
    const testimonials = await testimonialsService.getTestimonialsByRecipeId(recipeId);
...
export default {
  ...
  getTestimonialsByRecipeIdController: ctrlWrapper(getTestimonialsByRecipeIdController),
};
